...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white p-4">
      <div className="text-center mb-8">
        <BrainCircuit size={64} className="mx-auto text-blue-500" />
        {/* UPDATED: Text size is larger on sm screens and up */}
        <h1 className="text-3xl sm:text-4xl font-bold mt-4">Skill Logger</h1>
        <p className="text-gray-400">
          Track your learning, master your skills.
        </p>
      </div>
      <Card className="w-full max-w-md">
